...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/OWNER/REPO/blob/main/ptd_scraper.ipynb)

> Substitua `OWNER/REPO` pelo dono/nome deste repositório (badge do Colab) — ver `HANDOUT.md` §Setup.
