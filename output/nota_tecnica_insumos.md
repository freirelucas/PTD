...
- Distribuição de probabilidade (canônica): provável (182), pouco provável (173), muito provável (42), raro (26), praticamente certo (20); 152 não-canônicos (PDFs com templates não-padrão)
- Distribuição de impacto (canônica): alto (205), médio (146), muito alto (108), baixo (45); 91 não-canônicos
...
- 52% dos textos de risco reproduzem fraseamento do referencial padrão da SGD (texto idêntico em ≥3 órgãos)
...
- Dependência de fornecedores é o risco mais transversal: 23 riscos em 22 órgãos, 15 na zona crítica

**Concentração e homogeneidade:**
- PPSI é o produto mais difundido (91% dos órgãos), seguido de Login Único (81%)
